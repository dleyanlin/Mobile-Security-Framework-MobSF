...
class Constants(object):
    ...
    # LOCAL TOOLS
    PATH_LIBS = os.path.join(sys.path[0], 'MobSF/iosdevice/libs')
    ...
    DEVICE_SETUP = {
        ...
        'TOOLS': {
            ...
            'KEYCHAIN_DUMP': {'COMMAND': 'keychaineditor', 'PACKAGES': None, 'REPO': None, 'LOCAL': os.path.join(PATH_DEVICETOOLS, 'keychaineditor')},
